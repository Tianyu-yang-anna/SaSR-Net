...
class MGN_Net(nn.Module):
    ...
    def __init__(self, args):
        ...
        # learnable tokens
        self.av_token = nn.Parameter(torch.zeros(22, args.dim))
    ...
    def forward(self, audio, visual, visual_st):
        ...
        x2, attn_visual_dict, v_attn = self.visual_cug(x2_0, self.av_token, return_attn=True)
        ...
        #vis_cls_prob = self.fc_cls(self.av_token)                           # [25, 25]
        ...
        return x1, x2, av_cls_prob,  global_prob, a_prob, v_prob, a_frame_prob, v_frame_prob, a_attn, v_attn
